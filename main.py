...
def help_text():
    while True:
        ...
        description_help1 = text_description_aboutgame.render(" suggestion for enhancement of game you can ", True,
                                                              (255, 255, 255))
        description_help2 = text_description_aboutgame.render("simply mail on  \"mrahul23@iitk.ac.in\". ", True,
                                                              (255, 255, 255))
...
def about_text():
    ...
    while True:
        ...
        description_developer = text_description_aboutgame.render("This game is designed and written by", True,
                                                                  (255, 255, 255))
        description_developer1 = text_description_aboutgame.render("rahul", True, (255, 255, 255))
